...
async function generateExcel() {
  ...
  for (const scholarship of scholarships) {
    ...
    for (let i = 0; i < APPS_PER_SCHOLARSHIP; i++) {
      appCounter++;
    ...
    summaryData.push({
      ...
      total: APPS_PER_SCHOLARSHIP,
      approvalRate: Number(((approvedCount / APPS_PER_SCHOLARSHIP) * 100).toFixed(1))
    });
  }
  ...
  console.log('  2. Historical Applications   - 50 apps per scholarship with applicant snapshots');
